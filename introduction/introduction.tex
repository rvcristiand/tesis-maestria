...
Con los resultados del análisis del modelo, el posprocesador de ETABS puede \emph{diseñar} los elementos estructurales de acuerdo a uno de varios códigos de diseño de diferentes países. ETABS es capaz de diseñar:
\begin{itemize}
    \item pórticos en acero,
    \item pórticos en concreto,
    \item vigas compuestas,
    \item columnas compuestas,
    \item vigas en acero de alma abierta (\emph{steel joist}),
    \item muros a cortante,
    \item losas de concreto,
    \item conexiones en acero.
\end{itemize}
