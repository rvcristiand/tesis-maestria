...
Adicionalmente, según \cite{ETABS2019welcome}, ETABS cuenta con la posibilidad de generar dibujos estructurales esquemáticos de las plantas estructurales, de los despieces de vigas, columnas y muros a cortante, y detalles de las conexiones de acero.\\
...
\section{Metodología}
Se desarrollaron los programas de computador \emph{pyFEM} y \emph{FEM.js}. El primero para analizar estructuras tridimensionales tipo pórtico sometidas a cargas estáticas y el segundo para modelar estructuras tridimensionales. Esto con el fin que FEM.js pueda ser usado junto con otro programa de computador diferente a pyFEM.\\

Durante el desarrollo de estos programas se utilizó \emph{git} como sistema de control de versiones. Según \cite{chacon2014git}, git fue creado en 2005 por Linus Torvalds para ser usado durante el desarrollo del kernel del sistema operativo Linux teniendo en cuenta que debía ser rápido, de diseño simple, con gran soporte para el desarrollo no lineal, completamente distribuido y en la capacidad de manejar proyectos tan grandes como el kernel de Linux de manera eficiente.\\
