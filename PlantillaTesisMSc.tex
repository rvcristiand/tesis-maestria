...
% Nota: para hacer algunas anotaciones en la revisión
\newtcolorbox{nota}{
  sidebyside,
  colframe = red,
  collower = red!90!black
}
...
\tikzstyle{class}=[rectangle, draw=black, rounded corners, text centered, anchor=north, text width=3cm] % drop shadow, fill=blue!40, text=white,
\tikzstyle{atributos}=[rectangle, draw=black, anchor=center]
\tikzstyle{metodos}=[rectangle, draw=black, anchor=north]
